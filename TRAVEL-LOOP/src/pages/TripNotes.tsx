...
const notes = [
  {
    ...
    content: "Check-in after 2pm, Room 402, breakfast included (7-10am). Support number: +39 06 123 4567.",
    date: "Sep 5 - June 12, 2026",
    category: "Stay",
    important: true,
  },
  {
    id: 2,
    title: "Hotel check-in details - Paris stop",
    content: "Check-in after 3pm, Room 105, breakfast included (8-11am). Contact: Marc.",
    date: "Sep 5 - June 12, 2026",
    category: "Stay",
    important: false,
  },
  {
    id: 3,
    title: "Vatican Museum Entry",
    content: "Booking Ref: VAT-9982. Arrive 15 mins early at the north entrance.",
    date: "Sep 8, 2026",
    category: "Activity",
    important: true,
  }
    ...
    <div className="max-w-4xl mx-auto space-y-10 py-6">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Button className="h-16 px-8 rounded-2xl bg-primary hover:bg-primary/90 text-white font-black text-lg shadow-xl shadow-primary/20">
            ...
            <Card className={`bg-card/40 backdrop-blur-md border-border/40 hover:border-primary/30 transition-all rounded-3xl overflow-hidden shadow-2xl relative ${note.important ? 'ring-2 ring-primary/20' : ''}`}>
              ...
              <CardHeader className="p-6 pb-2 flex flex-row items-start justify-between">
                <div className="space-y-1.5">
                  ...
                  <h3 className="text-xl font-black tracking-tight group-hover:text-primary transition-colors">{note.title}</h3>
                </div>
